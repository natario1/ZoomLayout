...
open class ZoomLayout private constructor(
    ...
    init {
        ...
        val singleFingerScrollEnabled = a.getBoolean(R.styleable.ZoomEngine_singleFingerScrollEnabled, true)
        ...
        setSingleFingerScrollEnabled(singleFingerScrollEnabled)
